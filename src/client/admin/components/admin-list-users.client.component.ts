...
import { ExportUsersModalContext, ExportUsersModal } from './export-users.client.component';
...
import { ExportConfigService } from '../../shared/services/export-config.client.service';
import { ConfigService } from '../../core/services/config.client.service';

@Component({
	templateUrl: '../views/admin-list-users.client.view.html'
})
