...
import { CacheEntriesService, CacheEntry } from '../services/cache-entries.client.service';
...
import { ViewCacheEntryModal, ViewCacheEntryModalContext } from './view-cache-entry.client.component';

@Component({
	selector: 'cache-entries',
	templateUrl: '../views/admin-cache-entries.client.view.html'
})
