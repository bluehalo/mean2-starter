...
import {Component, forwardRef, Input, Output, OnInit, EventEmitter, ElementRef, Provider, Renderer, ViewChild, ViewContainerRef} from '@angular/core';
...
@Component({
	...
	templateUrl: '../views/in-line-edit.client.view.html'
})
